...
class TestNetworkHelpers:
    ...
    def test_cipher_strength_validation(self):
        ...
        """
        passes, cipher_info = SSLValidator.verify_cipher_strength("apple.com", min_bits=128)
...
class TestDataFactories:
    ...
    def test_truncated_hash_collision_rate(self):
        ...
        assert collision_rate < 0.05, f"Collision rate too high: {collision_rate:.2%}"
...
class TestPerformanceMonitoring:
    ...
    def test_with_performance_monitor(self, logger):
        ...
        # Measure DNS lookup
        dns_result = monitor.measure_operation("DNS Lookup", socket.gethostbyname, "apple.com")
        ...
        conn_result = monitor.measure_operation("TCP Connection", connect_tcp)
